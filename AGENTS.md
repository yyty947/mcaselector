...
- Phase 6 automated hardening is implemented: 63 tests pass, including semantic preset normalization, Builder restoration, Change/Force parity, selection relight-ring expansion, pre-1.18 fail-closed execution, modern preview/execution parity, and heightmaps. Translation completeness and `build shadowJar` pass.
- Packaging, DataVersion 2860/4671 and 26.3 snapshot file checks, real biome boundaries, Minecraft load/save/reload, and game-log review have evidence. The remaining gates are a short Builder rerun, a 1.21 adjacent-ring relight check, a 26.3 copied-world game load, and a final JDK FX package rerun. Do not mark Phase 6 complete until they pass.
