...
- Phase 6 packaging and file-level copied-world checks pass with Zulu 21 JDK FX and disposable DataVersion 2860/4671 copies. Remaining release gates are dual-locale JavaFX interaction, a real stored biome boundary, Minecraft load/save/reload, visual state/light inspection, and game-log review. Do not mark Phase 6 complete until all required gates pass.
